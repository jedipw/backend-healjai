...
router.post('/saveUserTagNumber', async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Save Tag number successfully' });
    } catch (error) {
        console.error(error);
        res.status(500).json({ message: 'Failed to save Tag number' });
    }
})
...
router.post('/saveUserData', async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Save user data successfully' });
    } catch (error) {
        console.error(error);
